...
def train_evaluate(params):
    ...
    max_cores = min(4, os.cpu_count())  # limit to avoid oversubscription
    #model = RandomForestRegressor(n_jobs=max_cores, random_state=42, **params)
    model = RandomForestRegressor(n_jobs=2, random_state=42, **params)
...
local_results = Parallel(n_jobs=2)(
